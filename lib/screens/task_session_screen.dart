        ...
        child: Padding(
          ...
          child: Consumer<SettingsProvider>(
            builder: (context, settings, _) => ChangeNotifierProvider(
              create: (context) =>
                  TaskSessionProvider(task: widget.task, settings: settings),
                  ...
                  Consumer<TaskSessionProvider>(
                    builder: (_, tsp, __) {
                      ...
                      if (tsp.state == TaskSessionState.initial ||
                        ...
                        canPause = false;
                      } else if (tsp.state == TaskSessionState.sessionRunning ||
                          tsp.state == TaskSessionState.breakRunning ||
                          tsp.state == TaskSessionState.longBreakRunning) {
                        canPause = true;
                        btnTitle = 'Pause';
                      } else if (tsp.state == TaskSessionState.sessionPaused ||
